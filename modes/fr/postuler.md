...
5. **speedrun-career-ops proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/speedrun contacto` pour du LinkedIn outreach vers le hiring manager
