...
→ Run /speedrun pipeline to evaluate the new offers.
```

## careers_url Management

Each company in `tracked_companies` must have a `careers_url` — the direct URL to their job listings page. This avoids searching for it every time.
