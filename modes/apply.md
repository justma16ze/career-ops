...
5. **speedrun-career-ops proof point**: Include in "Additional info" if there's a field for it
...
3. Suggest next step: `/speedrun contacto` for LinkedIn outreach
