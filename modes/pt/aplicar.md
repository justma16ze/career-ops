...
5. **speedrun-career-ops proof point**: Incluir em "Informacoes adicionais" se houver campo para isso
...
3. Sugerir proximo passo: `/speedrun contacto` para LinkedIn outreach
