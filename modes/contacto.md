...
3. **Generate message** using a 3-sentence framework:
   ...
   - **Sentence 2 (Proof)**: The candidate's biggest quantifiable achievement relevant to THAT role (e.g., "I built an AI agent handling 90% of customer service at my company before selling it")
