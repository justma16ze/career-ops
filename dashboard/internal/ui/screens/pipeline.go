...
import (
	...
	"github.com/a16z/speedrun-career-ops/dashboard/internal/data"
	"github.com/a16z/speedrun-career-ops/dashboard/internal/model"
	"github.com/a16z/speedrun-career-ops/dashboard/internal/theme"
)
...
func (m PipelineModel) renderHelp() string {
	...
	brand := lipgloss.NewStyle().Foreground(m.theme.Overlay).Render("speedrun-career-ops by a16z")
