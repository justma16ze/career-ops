# speedrun-career-ops Batch Worker — Complete Evaluation + PDF + Tracker Line
...
3. **"If downleveled" plan**: accept if comp is fair, negotiate 6-month review, clear criteria
...
**PDF:** speedrun-career-ops/output/cv-candidate-{company-slug}-{{DATE}}.pdf
**Batch ID:** {{ID}}
...
- Header: Space Grotesk 24px bold + cyan-to-purple gradient 2px + contact row
